...
async function loadPage(pageName){
  ...
  try {
    ...
    if(pageName === 'news')      { renderBanners(); renderDailyPick(); }
  } catch(e){
...
function renderBanners(){
  ...
  wrap.innerHTML = visible.map(b => `
    <div class="banner-slide">
      <img src="${esc(b.url)}" class="banner-img" alt="${b.label || 'Banner'}"
