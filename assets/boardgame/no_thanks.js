GAMES.push({
  ...
  turn: [
    ...
    "Từ chối (No Thanks!): Bạn đặt 1 chip của mình lên lá bài và nói 'No Thanks!'. Lượt chơi chuyển cho người tiếp theo bên trái."
  ],
  win: "Người chơi có tổng điểm từ các lá bài (trừ đi số chip còn lại) thấp nhất sẽ giành chiến thắng.",
  tips: [
    "Cố gắng thu thập các lá bài tạo thành chuỗi liên tiếp để giảm điểm phạt.",
    "Quản lý chip cẩn thận, đừng để hết chip sớm vì bạn sẽ buộc phải lấy mọi lá bài.",
    "Ép đối thủ phải lấy những lá bài điểm cao bằng cách bồi thêm chip vào đó."
  ],
  images: [
    { url: "https://i.ytimg.com/vi/wA3LdhgA8BE/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCjbNGUF-qNuMUaXwLR8Xxn5QzCYA", caption: "Lối chơi đơn giản nhưng đầy tính toán của No Thanks!" }
  ],
